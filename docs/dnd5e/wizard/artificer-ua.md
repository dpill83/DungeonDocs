...
Resistance
Infuse Scrolls
At 2nd level, you can also tap into your reserves of magical energy to create
spell scrolls
...
Master Artificer
On reaching 14th level, your mastery of arcane magic allows you to produce a variety of magic items. You can create a single item chosen from
Magic Item Tables A and B
in chapter 7 of the Dungeon Master’s Master’s Guide. It takes you 1 week to produce such an item, and you must rest for 1 month before using this ability to craft another item.
