...
Light and Flame.
While attuned to the lantern, you can verbally ask the elemental to glow (no action required), causing the lantern to cast bright light in a radius of your choice up to 60 feet and dim light for the same distance beyond that. You can also cast the
Produce Flame
cantrip from the lantern at will. Wisdom is your spellcasting ability for this spell.
Elemental Essence.
...
You can cast the
Burning Hands
spell (spell save DC 15) from the lantern at 3rd level. Once you cast the spell, you can’t do so again until the next time you use this property of the lantern.
