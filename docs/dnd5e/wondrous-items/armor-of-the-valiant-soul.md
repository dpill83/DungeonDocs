...
Command
spell (save DC 14) while attuned to this armor. Once this property is used, it can’t be used again until you finish a long rest.
Awakened.
When the
Armor of the Valiant Soul
...
The spell save DC for the armor’s
Command
spell increases to 16, and the spell can target up to three creatures.
Exalted.
When the
Armor of the Valiant Soul
...
The spell save DC of the armor’s
Command
spell increases to 18, and the spell can target up to five creatures.
