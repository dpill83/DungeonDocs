...
While attuned to the weapon, the sword’s wielder can use the sword to cast the
Crusader's Mantle
spell. Once used, this property of the sword can’t be used again until the next dawn.
