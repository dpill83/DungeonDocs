...
Ray of Frost
(+5 to hit) targeting a random creature within 60 feet that doesn't have total cover against the attack.
7-8
The dodecahedron casts
Shocking Grasp
(+5 to hit) on the next creature that touches it.
9-10
The dodecahedron casts
Darkness
on itself. The effect has a duration of 10 minutes.
11-12
