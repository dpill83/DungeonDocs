...
Gain the Ranger's level 1 features, which are listed in the Ranger Features table. See the multiclassing rules in
multiclassing
...
You have learned to channel the magical essence of nature to cast spells. See Chapter 7 for the rules on Spellcasting. The Information below details how you use those rules with Ranger spells, which appear in the
Ranger spell list
...
You learn two
Druid cantrips
of your choice (See the Druid class's section for a list of Druid spells).
Guidance
and
Starry Wisp
...
or another
feat of your choice
for which you qualify. You gain this feature again at Ranger levels 8, 12, and 16.
