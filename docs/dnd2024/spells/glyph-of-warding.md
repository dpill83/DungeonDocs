...
Casting Time: 1 hour
Range: Touch
Components: V, S, M (Incense & Powdered Diamond Dust, 200gp)
...
The damage of an explosive rune increases by 1d8 for each spell slot level above 3. If you create a spell glyph, you can store any spell of up to the same level as the spell slot you use for the
Glyph of Warding.