...
| Feature                | Details                                      |
|------------------------|----------------------------------------------|
| **Ability Scores** | Strength<br>Intelligence<br>Wisdom |
| **Feat** | Alert |
| **Skill Proficiencies** | Athletics<br>Perception |
| **Tool Proficiency** | Choose one kind of Gaming Set |
| **Equipment** | <ul><li><strong>A:</strong> Spear<br>Light Crossbow<br>20 Bolts<br>Gaming Set (same as above)<br>Hooded Lantern<br>Manacles<br>Quiver<br>Traveler’s Clothes<br>12 GP</li><li><strong>B:</strong> 50 GP</li></ul> |
