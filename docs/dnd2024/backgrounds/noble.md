...
| Feature                | Details                                      |
|------------------------|----------------------------------------------|
| **Ability Scores** | Strength<br>Intelligence<br>Charisma |
| **Feat** | Skilled |
| **Skill Proficiencies** | History<br>Persuasion |
| **Tool Proficiency** | Choose one kind of Gaming Set |
| **Equipment** | <ul><li><strong>A:</strong> Gaming Set (same as above)<br>Fine Clothes<br>Perfume<br>29 GP</li><li><strong>B:</strong> 50 GP</li></ul> |
