...
<div align="center">
  <img src="https://www.runicdice.com/cdn/shop/articles/Peace_Domain_Cleric_Guide_for_Beginners_Mastering_the_Peace_Cleric_in_D_D_5e.png?v=1763124075" alt="Peace Domain Cleric fostering bonds and calm among allies" width="900"/>
</div>

**Foster Bonds and Resolve Conflict**

The balm of peace thrives at the heart of healthy communities, between friendly nations, and in the souls of the kindhearted. The gods of peace inspire people to resolve conflict and to stand against forces that prevent peace from flourishing. Clerics of the Peace Domain preside over the signing of treaties and arbitrate disputes. Peace deities include Angharradh (Elven), Berronar Truesilver (Dwarven), Boldrei (Eberron), Cyrrollalee (Halfling), Eldath (Forgotten Realms), Gaerdal Ironhand (Gnomish), Paladine (Dragonlance), and Rao (Greyhawk).
...
When you reach a Cleric level specified in the Peace Domain Spells table, you thereafter always have the listed spells prepared.

| Cleric Level | Prepared Spells                                      |
|--------------|------------------------------------------------------|
| 3            | Heroism, Sanctuary, Aid, Warding Bond                |
| 5            | Beacon of Hope, Sending                              |
| 7            | Aura of Purity, Otiluke's Resilient Sphere            |
| 9            | Greater Restoration, Rary's Telepathic Bond           |

<div align="center">
  <img src="https://static0.cbrimages.com/wordpress/wp-content/uploads/2021/09/dnd-5e-cleric.jpg" alt="Peace Cleric extending Balm of Peace" width="750"/>
</div>

## Level 3: Channel Divinity — Balm of Peace

As a Magic action, you can move up to your speed without provoking opportunity attacks. When you move within 5 feet of any other creature during this action, you can restore a number of Hit Points to that creature equal to 2d6 + your Wisdom modifier (minimum of 1). A creature can receive this healing only once whenever you take this action.
